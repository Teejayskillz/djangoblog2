...
from .views import (
    home, CategoryView, PostDetailView, search, download_quality, 
    download_subtitle, TagDetailView, PageView, MediaListView, 
    MediaDetailView, register, activate  # Add 'activate' here
)
from . import views
...
urlpatterns = [
    ...
    path('activate/<uidb64>/<token>/', activate, name='activate'),  # ADD THIS LINE
